...
public class Card implements ICard {
    ...
    private static final String[] rankStrings = { "jack", "nine", "ace", "ten", "king", "queen", "eight", "seven" };

    // Janith asked to write this class. why, I have no memory.
    // oh wait, i think it was meri, my guess is, something to do with android.
    public static final Map<String, String> cardMap = Collections.unmodifiableMap(
    /*
     * This is really an anonymous inner class - a sub-class of j.u.HashMap
     */
    ...
    public Card(int suit, int rank) {
        ...
        cardDesc = rankStrings[rank] + " of " + suitStrings[suit];
    }
    ...
    public String descPrintableSuite(int suite) {
        String origSuite = suitStrings[suite];
        switch (origSuite) {
            case "hearts":
                return "hrt";
            case "diamonds":
